...
@AndroidEntryPoint
class ListAlarmVoicePeriodJFFragment :
    BaseFragment<FragmentListScheduleAlarmCameraJfBinding, ListAlarmVoicePeriodJFViewModel>() {
    ...
    override fun getVM(): ListAlarmVoicePeriodJFViewModel = viewModel
    ...
    private fun initLayout() {
        binding.tvListAlarmNull.text = "Âm thanh cảnh báo sẽ được bật theo lịch trình cài đặt"
    ...
    private fun openAddScheduleAlarm(scheduleId: Int = -1) {
        ...
        appNavigation.openAddAlarmVoicePeriodJFCamera(bundle)
    }

    companion object {
        private const val TAG = "AlarmVoicePeriodJFFragment"
    }
}
