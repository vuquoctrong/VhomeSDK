...
public class ZoomableTextureView extends TextureView {
    ...
    public ZoomOnTouchListeners zoomOnTouchListeners;
    public TextScaleNumber textScaleNumber;
    ...
    private void initView(AttributeSet attrs) {
        ...
        zoomOnTouchListeners = new ZoomOnTouchListeners();
    ...
    public class ZoomOnTouchListeners implements OnTouchListener {
        ...
        private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
            ...
            public boolean onScale(ScaleGestureDetector detector) {
                ...
                if(textScaleNumber !=null){
                    textScaleNumber.getNumberScale(saveScale);
                }
   ...
   public interface TextScaleNumber{
        void getNumberScale(Float number);
   }
