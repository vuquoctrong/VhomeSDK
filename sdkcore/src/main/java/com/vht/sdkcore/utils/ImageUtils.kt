...
fun ImageView.loadImage(bitmap: Bitmap, corner: Int) {
    Glide.with(this)
        .load(bitmap)
...
fun ImageView.loadImage(urlImage: File, corner: Int) {
    Glide.with(this)
        .load(urlImage)
        .apply(RequestOptions().transform(CenterCrop(), RoundedCorners(corner)))
        .into(this)
...
fun ImageView.loadImage(resDrawable: Int, corner: Int) {
    Glide.with(this)
        .load(resDrawable)
        .apply(RequestOptions().transform(CenterCrop(), RoundedCorners(corner)))
        .into(this)
...
fun ImageView.loadImage(uri: Uri, corner: Int) {
    Glide.with(this)
        .load(uri)
        .apply(RequestOptions().transform(CenterCrop(), RoundedCorners(corner)))
        .into(this)
...
fun ImageView.loadImageFromSrc(source: Int) {
    Glide.with(this)
        .load(source)
        .into(this)
}
