        ...
        when (wifiManager.connectionInfo.frequency) {
            in 2400..2499 -> onSuccess.invoke()
                ...
                CommonAlertDialogNotification.getInstanceCommonAlertdialog(this)
                    .showDialog()
                    .setDialogTitleWithString(getString(R.string.wifi_connect_may_not_be_on_band_support))
                    .setContent(getString(R.string.please_check_again_to_ensure_connection))
                    .showCenterImage(DialogType.ERROR_CONFIG)
                    .setTextNegativeButtonWithString(getString(R.string.cancel_text))
                    .setOnNegativePressed {
                        it.dismiss()
                    }
                    .setTextPositiveButtonWithString(getString(R.string.continue_text))
